...
{
    /// <inheritdoc />
    public partial class KaueBonitinhoeFofinho : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantEmployees = table.Column<int>(type: "INTEGER", nullable: false),
                    QuantBook = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
